...
- [ ] Confirm package metadata (name, description, repository, keywords, license) and `bin` map points to [`opencrab.mjs`](https://github.com/Eunho-J/opencrab/blob/develop/opencrab.mjs) for `opencrab`.
