...
describe("infra parsing", () => {
  ...
  describe("isMainModule", () => {
    ...
    it("returns true for dist/entry.js when launched via opencrab.mjs wrapper", () => {
      expect(
        isMainModule({
          currentFile: "/repo/dist/entry.js",
          argv: ["node", "/repo/opencrab.mjs"],
          cwd: "/repo",
          env: {},
          wrapperEntryPairs: [{ wrapperBasename: "opencrab.mjs", entryBasename: "entry.js" }],
        }),
      ).toBe(true);
    });
