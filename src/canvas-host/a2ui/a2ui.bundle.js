...
var OpenCrabA2UIHost = class extends i$6 {
  static properties = {
    surfaces: { state: true },
  ...
  static styles = i$9`
    :host {
      ...
      box-sizing: border-box;
      padding:
        var(--opencrab-a2ui-inset-top, 0px)
        var(--opencrab-a2ui-inset-right, 0px)
        var(--opencrab-a2ui-inset-bottom, 0px)
        var(--opencrab-a2ui-inset-left, 0px);
    }
    ...
    #surfaces {
      ...
      height: 100%;
      overflow: auto;
      padding-bottom: var(--opencrab-a2ui-scroll-pad-bottom, 0px);
    }
    ...
    .status {
      ...
      top: var(--opencrab-a2ui-status-top, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .toast {
      ...
      left: 50%;
      transform: translateX(-50%);
      bottom: var(--opencrab-a2ui-toast-bottom, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .empty {
      ...
      left: 50%;
      transform: translateX(-50%);
      top: var(--opencrab-a2ui-empty-top, var(--opencrab-a2ui-status-top, 12px));
      text-align: center;
      opacity: 0.8;
      padding: 10px 12px;
      pointer-events: none;
  ...
  connectedCallback() {
    ...
    globalThis.opencrabA2UI = api;
    this.addEventListener("a2uiaction", (evt) => this.#handleA2UIAction(evt));
    this.#statusListener = (evt) => this.#handleActionStatus(evt);
    for (const eventName of ["opencrab:a2ui-action-status"]) {
  ...
  #handleA2UIAction(evt) {
    ...
    globalThis.__opencrabLastA2UIAction = userAction;
    const handler =
      globalThis.webkit?.messageHandlers?.opencrabCanvasA2UIAction ??
      globalThis.opencrabCanvasA2UIAction;
    if (handler?.postMessage) {
      try {
        if (handler === globalThis.opencrabCanvasA2UIAction) {
...
if (!customElements.get("opencrab-a2ui-host")) {
  customElements.define("opencrab-a2ui-host", OpenCrabA2UIHost);
}
