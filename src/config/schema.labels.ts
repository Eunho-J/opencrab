...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.web.search.cometMcp.serverName": "Comet MCP Server Name",
  "tools.web.search.cometMcp.mode": "Comet MCP Mode",
  "tools.web.search.cometMcp.timeoutMs": "Comet MCP Timeout (ms)",
  "tools.web.search.cometMcp.fallbackToBrave": "Comet MCP Fallback to Brave",
